            ...
            <div className="flex flex-col items-center justify-center h-full gap-6 pt-20">
              {navLinks.map((link, index) => (
                <motion.a
                  ...
                  href={link.href}
                  onClick={(e) => { e.preventDefault(); scrollToSection(link.href); }}
                  className="text-2xl font-semibold text-foreground hover:text-[#0d6efd] transition-colors"
              ...
              >
                <Button
                  onClick={() => { setIsMobileMenuOpen(false); onLeadClick(); }}
                  className="bg-[#0d6efd] hover:bg-[#0056e9] text-white font-semibold px-8 py-6 text-lg"
                >
                  Get Started
                </Button>
              </motion.div>
